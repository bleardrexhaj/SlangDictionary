...
INSERT INTO term (id, author, definition, example, thumbs_down, thumbs_up, word, written_on, user_id, category_id) values (18, "Enkhjargal", "TA static description of a dynamic process in the form of a stored program used to solve a problem on a machine.", "You are writing software to wash your dishes? what is sofware?", 101, 11, "software", '2020-08-08 00:00:00',2, 2)
